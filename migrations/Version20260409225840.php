 ...
 */
final class Version20260409225840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, invoice_number VARCHAR(50) DEFAULT NULL, invoice_date DATE NOT NULL, status VARCHAR(50) DEFAULT NULL, total DOUBLE PRECISION DEFAULT NULL, customer_id INT DEFAULT NULL, repair_id INT DEFAULT NULL, INDEX IDX_906517449395C3F3 (customer_id), UNIQUE INDEX UNIQ_9065174443833CFF (repair_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
